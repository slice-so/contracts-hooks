...
} from "../../../../contracts/utils/juiceboxV1/ExampleModAllocator";
...
export class ExampleModAllocator__factory extends ContractFactory {
  ...
  override attach(address: string): ExampleModAllocator {
    return super.attach(address) as ExampleModAllocator;
  }
  override connect(signer: Signer): ExampleModAllocator__factory {
