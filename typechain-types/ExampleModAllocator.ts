...
export interface ExampleModAllocatorInterface extends utils.Interface {
  contractName: "ExampleModAllocator";
  functions: {
...
export interface ExampleModAllocator extends BaseContract {
  contractName: "ExampleModAllocator";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExampleModAllocatorInterface;
