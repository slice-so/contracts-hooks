...
export interface ExampleJuiceboxProjectInterface extends utils.Interface {
  contractName: "ExampleJuiceboxProject";
  functions: {
    ...
    "takeFee(uint256,address,string,bool)": FunctionFragment;
...
export interface ExampleJuiceboxProject extends BaseContract {
  contractName: "ExampleJuiceboxProject";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExampleJuiceboxProjectInterface;
