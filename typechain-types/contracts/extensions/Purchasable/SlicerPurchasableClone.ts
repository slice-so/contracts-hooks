...
export interface SlicerPurchasableCloneInterface extends utils.Interface {
  functions: {
...
export interface SlicerPurchasableClone extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SlicerPurchasableCloneInterface;
