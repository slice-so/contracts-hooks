...
export interface SlicerPurchasableConstructorInterface extends utils.Interface {
  functions: {
...
export interface SlicerPurchasableConstructor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SlicerPurchasableConstructorInterface;
