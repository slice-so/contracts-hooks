...
export interface ERC721GatedImmutableInterface extends utils.Interface {
  functions: {
...
export interface ERC721GatedImmutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721GatedImmutableInterface;
