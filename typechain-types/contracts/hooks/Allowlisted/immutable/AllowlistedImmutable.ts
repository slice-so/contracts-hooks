...
export interface AllowlistedImmutableInterface extends utils.Interface {
  functions: {
...
export interface AllowlistedImmutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AllowlistedImmutableInterface;
