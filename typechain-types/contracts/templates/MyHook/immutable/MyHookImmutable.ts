...
export interface MyHookImmutableInterface extends utils.Interface {
  functions: {
...
export interface MyHookImmutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyHookImmutableInterface;
