...
export interface FundingCyclesInterface extends utils.Interface {
  functions: {
...
export interface FundingCycles extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FundingCyclesInterface;
  ...
  functions: {
    ...
    currentOf(
      ...
      [FundingCycleStructOutput] & { fundingCycle: FundingCycleStructOutput }
    >;
