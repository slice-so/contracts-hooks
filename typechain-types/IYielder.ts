...
export interface IYielderInterface extends utils.Interface {
  contractName: "IYielder";
  functions: {
...
export interface IYielder extends BaseContract {
  contractName: "IYielder";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IYielderInterface;
