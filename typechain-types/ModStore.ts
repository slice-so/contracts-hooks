...
export interface ModStoreInterface extends utils.Interface {
  contractName: "ModStore";
  functions: {
...
export interface ModStore extends BaseContract {
  contractName: "ModStore";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ModStoreInterface;
