...
export interface MyHookFactoryInterface extends utils.Interface {
  contractName: "MyHookFactory";
  functions: {
...
export interface MyHookFactory extends BaseContract {
  contractName: "MyHookFactory";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyHookFactoryInterface;
