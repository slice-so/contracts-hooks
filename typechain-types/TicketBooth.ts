...
export interface TicketBoothInterface extends utils.Interface {
...
export interface TicketBooth extends BaseContract {
  contractName: "TicketBooth";
  ...
  functions: {
    ...
    ticketsOf(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
